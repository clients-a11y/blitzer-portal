          ...
          {(
            ...
            return (
              <Link
                ...
                className="bg-white rounded-2xl border border-slate-100 shadow-sm p-3 flex items-center gap-2.5 hover:border-sky-200 hover:shadow-md transition-all cursor-pointer"
              >
                <div
          ...
          <div className="flex-1 min-w-0">
            ...
            {messstellen.length === 0 ? (
              <div className="text-center py-16 bg-white rounded-2xl border border-slate-100 shadow-sm">
                ...
                <p className="text-slate-500 text-sm font-medium">Keine Messstellen gefunden.</p>
                <Link
                  href="/messstellen"
                  className="mt-3 inline-block text-xs text-sky-600 hover:text-sky-700 font-medium"
                >
                  Filter zurücksetzen
                </Link>
              </div>
              ...
              <div className="space-y-2.5">
                {messstellen.map((m) => {
                  ...
                  return (
                    <article
                      key={m.id}
                      className="bg-white rounded-2xl border border-slate-100 shadow-sm hover:shadow-md hover:border-sky-100 transition-all overflow-hidden flex"
                      itemScope
                    ...
                    >
                      ...
                      <div className="flex-1 p-4 flex flex-col sm:flex-row sm:items-center gap-3 min-w-0">
                        ...
                        <Link
                          href={href}
                          className="flex-shrink-0 inline-flex items-center gap-1.5 text-xs text-sky-600 font-semibold hover:text-sky-800 bg-sky-50 hover:bg-sky-100 px-3.5 py-2 rounded-xl transition-colors whitespace-nowrap cursor-pointer"
                        >
                          Details
                ...
                {bundeslaenderStats.map((bl) => (
                  <li key={bl.bundesland}>
                    <Link
                      ...
                      className="flex items-center justify-between py-2 px-2.5 rounded-xl text-xs hover:bg-sky-50 transition-all group cursor-pointer"
                    >
                      ...
                      <span className="bg-slate-100 group-hover:bg-sky-100 text-slate-500 group-hover:text-sky-700 font-semibold px-1.5 py-0.5 rounded-md text-[10px] transition-colors">
                        {bl._count.id}
                      </span>
                    </Link>
                  </li>
