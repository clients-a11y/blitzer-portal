...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/messstellen`, lastModified: new Date(), changeFrequency: 'daily', priority: 0.9 },
    { url: `${baseUrl}/suche`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.5 },
    { url: `${baseUrl}/bussgeldbehoerden`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.7 },
  ]
  ...
  try {
    ...
    return [...staticRoutes, ...bundeslaenderUrls, ...messstellenUrls]
  } catch {
    return staticRoutes
  }
}
